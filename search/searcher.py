...
def get_char_start(chunk: dict[str, Any]) -> int | None:
    provenance = chunk.get("provenance") or {}
    return provenance.get("char_start", chunk.get("char_start"))


def get_char_end(chunk: dict[str, Any]) -> int | None:
    provenance = chunk.get("provenance") or {}
    return provenance.get("char_end", chunk.get("char_end"))
            ...
            results.append(
                {
                    ...
                    "char_start": get_char_start(chunk),
                    "char_end": get_char_end(chunk),
